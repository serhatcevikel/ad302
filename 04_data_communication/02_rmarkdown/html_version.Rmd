...
Let's first create a copy of the flights table and make it a data.table. Add a date column. And create a summarized version of the table so that for each date and origin we have average departure delay, arrival delay and distance.

And later, let's add some additional features:
...
So we can render any interactive plots into an html document format (or other format according to the yaml header) using the Knit button or Ctrl+Shift+K shortcut.
