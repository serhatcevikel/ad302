        ...
        densityr <- reactive(
          {
            ...
            densities_dt <- mapply(function(x, y, z) data.table(qval = qvals, dens = x, distname = y, alphax = z),
                           densities, distnames, c(0.5, 1), SIMPLIFY = F) %>% rbindlist
